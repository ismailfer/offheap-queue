 ...
 * @since 20221016
 */
public class OffHeapUnsafeListTest
{
    ...
    public void testArrayList()
    {
        try
        {
            ...
            for (int i = 0; i < iterations; i++)
            {
                ...
                Assertions.assertTrue(d.notes.equals("Hello" + i));
    ...
    public void testOffHeapList_ReadingAndSeeking()
    {
        try
        {
            OffHeapUnsafeList list = new OffHeapUnsafeList("ListTest1", iterations * 150L + 100);
     ...
     */
    @Test
    public void testOffHeapList_MultiThread()
    {
        try
        {
            OffHeapUnsafeList queue = new OffHeapUnsafeList("ListTest1", iterations * 150L + 100);
            ...
            System.out.println("testOffHeapList_MultiThread(" + threadCount + "): Written/Read " + (iterations) + " in " + (nanos / 1000000.0) + " ms, avg="
     ...
     */
    @Test
    public void testOffHeapList_PublisherConsumerThreads()
    {
        try
        {
            OffHeapUnsafeList queue = new OffHeapUnsafeList("ListTest1", iterations * 150L + 100);
            ...
            System.out.println("testOffHeapList_MultiThread(" + readerThreadCount + "): Written/Read " + (iterations) + " in " + (nanos / 1000000.0) + " ms, avg="
                    + (0.1 * nanos / iterations) + " nanos per msg");
     ...
     */
    @Test
    public void testOffHeapListObjects()
    {
        try
        {
            //iterations = 10;

            OffHeapUnsafeList queue = new OffHeapUnsafeList("ListTest1", iterations * 2000 + 100);
            ...
            System.out.println("testOffHeapListObjects: Written/Read " + (iterations) + " in " + (nanos / 1000000.0) + " ms, avg=" + (0.1 * nanos / iterations) + " nanos per msg");
    ...
    {
        OffHeapUnsafeListTest app = new OffHeapUnsafeListTest();

        System.out.println("========= OffHeapUnsafeListTest - WARM UP ====================");
        ...
        app.testOffHeapList_ReadingAndSeeking();
        app.testOffHeapList_MultiThread();
        //app.testOffHeapQueueObjects();

        System.out.println();
        System.out.println("========= OffHeapUnsafeListTest - TEST ====================");
